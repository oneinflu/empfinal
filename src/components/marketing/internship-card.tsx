...
import { Briefcase01, Clock, MarkerPin01, Share04, Heart } from "@untitledui/icons";
    ...
    return (
        <div className="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:shadow-md">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
                ...
                <span className="px-3 py-1 rounded-full bg-gray-100 text-xs font-medium text-gray-600">+5</span>
