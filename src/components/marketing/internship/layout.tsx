...
import { InternshipHeader } from "./header";
import { InternshipSidebar } from "./sidebar";
import { OpportunityContent } from "@/components/marketing/opportunity/content";
import { Zap, CheckCircle } from "@untitledui/icons";

export const InternshipDetailLayout = ({ opportunity }: { opportunity: Opportunity }) => {
    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            <InternshipHeader opportunity={opportunity} />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20">
                <div className="grid lg:grid-cols-[1fr_360px] gap-8">
                            ...
                            <div className="grid sm:grid-cols-3 gap-4">
                                <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                                    ...
                                    <p className="text-sm text-gray-600 leading-snug">
                                        Your <strong>React</strong> experience aligns perfectly.
                                    </p>
                                </div>
                                <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                                    <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <p className="text-sm text-gray-600 leading-snug">
                                        Completed <strong>2 similar projects</strong>.
                                    </p>
                                </div>
                                <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                                    <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="hidden lg:block relative">
                         <InternshipSidebar opportunity={opportunity} />
                    </div>
                </div>
            </div>
        </div>
