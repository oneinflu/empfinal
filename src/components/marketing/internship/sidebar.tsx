...
export const InternshipSidebar = ({ opportunity }: { opportunity: Opportunity }) => {
    return (
        <div className="space-y-6">
                ...
                <div className="relative z-10">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <span className="text-lg font-bold text-gray-900">20 Feb 26</span>
                        </div>
                    ...
                    <div className="text-center text-sm text-gray-500 mb-6 flex items-center justify-center gap-2">
                        ...
                        <span><span className="font-bold text-gray-900">1,240</span> applicants</span>
                    </div>
                    ...
                    <div className="bg-green-50 rounded-xl p-4 border border-green-100">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <span className="font-bold text-green-900 block mb-0.5">Strong Profile</span>
                                <p className="text-green-700 text-xs">You match 4/5 top skills. Your chances are high!</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-900 leading-tight">Boost Your Chances</h3>
                        <p className="text-xs text-gray-500">1 skill improvement recommended</p>
                    </div>
                </div>
                
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 mb-4">
                    <div className="text-sm text-gray-700 mb-1">
                        Missing skill: <span className="font-bold text-gray-900">React Native</span>
                    </div>
                ...
                <Link href="/courses/react-native" className="block group">
                    <div className="flex items-center gap-4 p-3 hover:bg-gray-50 rounded-xl transition-colors border border-transparent hover:border-gray-100">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="font-bold text-gray-900 truncate">React Native Masterclass</div>
                            <div className="text-xs text-gray-500">By Meta • 4.8 ⭐</div>
                        </div>
            ...
            <div className="bg-gradient-to-br from-indigo-600 to-violet-700 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden group cursor-pointer">
                 ...
                 <h3 className="font-bold text-lg mb-2 relative z-10">Ace the Interview</h3>
                 <p className="text-indigo-100 text-sm mb-6 relative z-10">
                     Book a 1:1 session with a Senior Engineer at {opportunity.company}.
                 </p>
