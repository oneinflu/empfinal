...
export const DeleteConfirmationModal = ({ isOpen, onClose, onConfirm, title, description }: DeleteConfirmationModalProps) => {
    return (
                ...
                <Dialog className="relative flex flex-col p-6 rounded-xl bg-primary shadow-xl outline-none overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col">
                        ...
                        <div className="grid grid-cols-2 gap-3 mt-8">
                            ...
                            <Button color="primary-destructive" size="lg" onClick={() => { onConfirm(); onClose(); }} className="w-full justify-center">Delete</Button>
                        </div>
                    </div>
                </Dialog>
            </Modal>
