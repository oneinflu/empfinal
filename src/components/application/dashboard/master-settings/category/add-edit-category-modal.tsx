...
interface AddEditCategoryModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSave: (category: { name: string; parent: string | null }) => void;
    initialData?: { name: string; parent: string | null };
    parentOptions: SelectItemType[];
}

export const AddEditCategoryModal = ({ isOpen, onClose, onSave, initialData, parentOptions }: AddEditCategoryModalProps) => {
                    ...
                    <div className="relative z-10 flex flex-col">
                        ...
                        <div className="flex flex-col gap-1 mt-4">
                            ...
                            <p className="text-sm text-tertiary">
                                {initialData ? "Update the details of the selected category." : "Please enter the details for the new category."}
                            </p>
                        </div>
