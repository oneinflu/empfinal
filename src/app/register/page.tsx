...
export default function RegisterPage() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        // Simulate OTP flow or API call
        setTimeout(() => {
            setIsLoading(false);
            // logic to proceed to OTP verification would go here
            console.log("Proceeding with email:", email, "Role:", selectedRole);
        }, 1000);
    };
            ...
            <div className="relative z-10 w-full max-w-6xl bg-white rounded-[32px] shadow-2xl overflow-hidden min-h-[650px] grid md:grid-cols-2">
                ...
                <div className="flex items-center justify-center p-8 md:p-12 bg-white">
                    ...
                    {registerStep === 'selection' ? (
                        ...
                        >
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">Join Empedia</h1>
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                >
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Build your profile, learn skills, and land your dream job</p>
                                    </div>
                                </button>
                                ...
                                >
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-sm text-gray-600 mt-1">Find top talent and manage your hiring pipeline</p>
                                    </div>
                                </button>
                            </div>

                            <div className="text-xs text-gray-400 text-center px-4">
                                By signing up, you accept the <a href="#" className="text-blue-600 hover:underline">Terms of Service</a> and acknowledge our <a href="#" className="text-blue-600 hover:underline">Privacy Policy</a>.
                            </div>
                        </motion.div>
                    ) : (
                        <motion.div 
                        ...
                        >
                            <button 
                                onClick={() => setRegisterStep('selection')}
                            ...
                            <div className="flex flex-col gap-2">
                                <h1 className="text-3xl font-bold text-gray-900">
                                    {selectedRole === 'candidate' ? 'Create Candidate Account' : 'Create Employer Account'}
                                </h1>
                                <p className="text-md text-gray-500">Enter your email to verify and continue.</p>
                            </div>
